 ...
 implements ClientAndServer.ClientOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("setCamServer", new java.lang.Integer (3));
    _methods.put ("resetCamStatus", new java.lang.Integer (4));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 3:  // ClientAndServer/Client/setCamServer
       {
         String camID = in.read_string ();
       ...
       case 4:  // ClientAndServer/Client/resetCamStatus
       {
         this.resetCamStatus ();
         out = $rh.createReply();
         break;
